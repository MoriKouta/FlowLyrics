...
> This package is the `1.3.0-dev.11` confirmation build. It is not the final `1.3.0` release.
...
1. Download `FlowLyrics-v1.3.0-dev.11-win-x64-portable.zip` from the provided development build.
